...
const VERSION = "habit-log-v15";
const SHELL = ["/", "/journal", "/habits", "/pomodoro", "/goals", "/insights", "/gym", "/gym/insights", "/books", "/more", "/settings", "/auth/login", "/auth/signup", "/auth/recover", "/auth/reset-passphrase", "/manifest.webmanifest"];
